    ...
    where TCommand : ICommand<TData>
{
    ...
    public CommandHandler(EarthAttachedServices services)
    {
        _services = services;
    }
    ...
    {
        result.AddMessage(_services.Translator[message]);
    }
    protected void AddMessage(string message, params string[] arguments)
    {
        result.AddMessage(_services.Translator[message, arguments]);
    }
}
