using Dapper;
using Earth.Caching.Distributed.Sql.Options;
using Earth.Caching.Distributed.Sql.Services;
using Earth.Extension.Abstractions.Caching;
using Microsoft.Data.SqlClient;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace Earth.Caching.Distributed.Sql.Extensions.DependencyInjection;

public static class DistributedSqlCacheServiceCollectionExtensions
{
    public static IServiceCollection AddProjectSqlDistributedCache(this IServiceCollection services,
                                                                  IConfiguration configuration,
                                                                  string sectionName)
        => services.AddProjectSqlDistributedCache(configuration.GetSection(sectionName));

    public static IServiceCollection AddProjectSqlDistributedCache(this IServiceCollection services, IConfiguration configuration)
    {
        services.AddTransient<ICahceAdapter.ICacheAdapter, DistributedSqlCacheAdapter>();
