using Earth.Core.Contracts.ApplicationService.Events;
...
public static class HttpContextExtentions
{
    ...
    public static EarthAttachedServices EarthApplicationContext(this HttpContext httpContext) =>
        (EarthAttachedServices)httpContext.RequestServices.GetService(typeof(EarthAttachedServices));
}